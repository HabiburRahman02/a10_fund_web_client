...
const AboutUs = () => {
    return (
        <div className="max-w-[1200px] mx-auto py-10 px-8 md:px-0">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center">
                    ...
                    <button className="px-6 py-3 mb-10 text-lg font-medium text-white bg-first rounded-md shadow hover:bg-second transition duration-200">
                        Join Us Now
                    </button>
                </div>
            </div>
